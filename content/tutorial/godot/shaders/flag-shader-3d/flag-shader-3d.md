...
![Adding a new noise texture](.\images\new-noise.png)
...
![Adding new OpenSimplexNoise](.\images\new-open-simplex.png)
...
![Noisy flag](C:\Users\Johhny\Dropbox\gdquest\mini-tutorials\shader-flag\images\02.adding-noise.png)
...
```
![Stretched out noise](C:\Users\Johhny\Dropbox\gdquest\mini-tutorials\shader-flag\images\03.stretched-noise.png)
...
<video controls width="640">
   <source src="./videos/04.adding-movement.mp4" type="video/mp4">
</video>
...
<video controls width="640">
   <source src="./videos/04.slowing-movement.mp4" type="video/mp4">
</video>
...
<video controls width="640">
   <source src="./videos/05.fixing-offset.mp4" type="video/mp4">
</video>
...
<video controls width="640">
   <source src="./videos/06.adding-dampening.mp4" type="video/mp4">
</video>
...
<video controls width="640">
   <source src="./videos/07.rigid-shape.mp4" type="video/mp4">
</video>
...
```
<video controls width="640">
   <source src="./videos/07.distorted-shape.mp4" type="video/mp4">
</video>
